...
//#define DEFAULT_BACKGROUND_BUTTON       "background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,stop: 0 #8C8F8C, stop: 1 #0a00F8);" //

        #define DEFAULT_BACKGROUND_BUTTON       "background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,stop: 0 #ffffff, stop: 1 #ffffff);" //
        #define CHANGED_BACKGROUND_BUTTON       "background:lightgray;color:darkred;"
//015fF8
//#define DEFAULT_STYLE_BUTTON            "color:white;border: 1px solid #0100F8;border-radius:6px;"

        #define DEFAULT_STYLE_BUTTON            "color:black;border: 1px solid #0100F8;border-radius:6px;"
        ...
        #define KEY_SPACE                       " "
        #define KEY_WIDTH_EMBEDDED              20//30 //26
        #define KEY_HEIGHT_EMBEDDED             20//30 //22
        //
