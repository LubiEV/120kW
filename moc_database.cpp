...
QT_MOC_LITERAL(1, 9, 19), // "signalSelectCurrent"
QT_MOC_LITERAL(2, 29, 0) // ""

    },
    "Database\0signalSelectCurrent\0"
};
...
void Database::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalSelectCurrent((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Database::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Database::signalSelectCurrent)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Database::signalSelectCurrent(int _t1)
{
