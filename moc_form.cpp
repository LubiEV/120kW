...
QT_MOC_LITERAL(1, 5, 11), // "changevalue"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 26) // "returnWidgetSignalReceived"

    },
    "Form\0changevalue\0\0returnWidgetSignalReceived"
};
...
void Form::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changevalue((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->returnWidgetSignalReceived(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Form::changevalue)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Form::changevalue(QString _t1)
{
