...
QT_MOC_LITERAL(1, 5, 9), // "readReady"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 15), // "poll_read_ready"
QT_MOC_LITERAL(4, 32, 12) // "readrfid_COM"

    },
    "RFID\0readReady\0\0poll_read_ready\0"
    "readrfid_COM"
};
...
void RFID::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->readReady((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->poll_read_ready(); break;
        case 2: { int _r = _t->readrfid_COM((*reinterpret_cast< int(*)>(_a[1])));
        ...
        {
            using _t = void (RFID::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RFID::readReady)) {
                *result = 0;
                return;
            }
        }
